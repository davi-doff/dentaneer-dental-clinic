...
export const HomePage: React.FC = () => (
  <div className="space-y-16">
    <section className="bg-pastel-green-100 rounded-lg p-8 text-center">
      <h1 className="text-4xl md:text-5xl font-bold text-pastel-green-900 mb-4">คลินิกทันตกรรมพาสเทล</h1>
        ...
        <Card className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2">
                 <div className="p-8 bg-pastel-green-600 text-white rounded-l-xl">
                    <h3 className="text-2xl font-bold mb-4">Pastel Dental Clinic</h3>
                    <p>เราพร้อมดูแลรอยยิ้มของคุณ</p>
                    <div className="mt-8 space-y-4">
                        <p><strong>โทร:</strong> 02-123-4567</p>
                        <p><strong>อีเมล:</strong> contact@pasteldental.com</p>
                        <p><strong>Line:</strong> @pasteldental</p>
                        <p><strong>Facebook:</strong> /pasteldentalclinic</p>
                    </div>
                </div>
                <div className="p-8">
