...
const ToothIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2C9.25 2 7 4.25 7 7C7 8.85 8.1 10.45 9.65 11.25C8.82 12.35 8.25 13.63 8.25 15C8.25 17.07 9.93 18.75 12 18.75C14.07 18.75 15.75 17.07 15.75 15C15.75 13.63 15.18 12.35 14.35 11.25C15.9 10.45 17 8.85 17 7C17 4.25 14.75 2 12 2ZM11 20V22H13V20H11Z" />
  </svg>
);
const SparkleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9.93 2.55a2 2 0 0 0-1.86 0L3.54 5.2a2 2 0 0 0-1.09 1.7L2.03 12a2 2 0 0 0 1.09 1.7l4.53 2.65a2 2 0 0 0 1.86 0l4.53-2.65a2 2 0 0 0 1.09-1.7l.42-5.1a2 2 0 0 0-1.09-1.7Z"/>
        <path d="M14.5 10.5 12 8l-2.5 2.5L7 8l2.5 2.5L7 13l2.5-2.5L12 13l2.5-2.5L17 13l-2.5-2.5Z" />
    </svg>
);
